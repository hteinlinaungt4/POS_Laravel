                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="dropdown me-5">
                            <button class="btn btn-warning rounded dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="w-100"><i class="fa-solid fa-user me-2"></i></span><span class="">{{Auth::user()->name}}</span>
                            </button>
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="{{ route('user#profile') }}">Profile</a></li>
                              <li><a class="dropdown-item" href="{{ route('userpassword#changepage') }}">Change Password</a></li>
                              <li class="dropdown-item">

                                <form action="{{ route('logout')}}" method="post">
                                    @csrf
                                    <button class="btn w-100 text-black">
                                        <i class="fa-solid fa-right-from-bracket me-2 text-warning"></i> Logout
                                    </button>
                                </form>
                              </li>
                            </ul>
